...
public class myPoiTesting {
	...
	public void setUp() throws Exception {
		...
		System.setProperty("webdriver.gecko.driver", cs.driverString);
		driver = new FirefoxDriver();
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		file = new File(cs.fileString);
	...
	public void testUntitled2() throws IOException{
		...
		for (int i = 0; i < lastRow; i++) {
			...
			try {
				fileOut = new FileOutputStream(cs.fileString);
			...
			try {
				...
				if(scoreExist){
					...
					String testResult = "Score does'nt exist yet.";
